...
class SensorPlot_WebInterface {
    ...
    public: 
        ...
        void addPlot(String title, String unit, int interval, int lower, int upper, int min, int max, int stepsize, int cycle, int cycleStepsize, int *valuesCount, float *values, int *valuesMeasurmentMillis);
		void interfaceConfig(String websiteTitle, String callbackInput, String callbackButton, String otherButton);
